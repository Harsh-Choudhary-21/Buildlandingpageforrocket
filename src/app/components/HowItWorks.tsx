        ...
        <div className="grid md:grid-cols-2 gap-8">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative p-8 rounded-2xl bg-gray-950 border-2 border-white/10 hover:border-purple-500/50 transition-all duration-300 shadow-lg hover:shadow-[0_10px_40px_rgba(168,85,247,0.25)]"
            >
              <div className="absolute -top-4 -left-4 w-12 h-12 rounded-full bg-gradient-to-br from-purple-700 to-purple-800 flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-purple-400/50">
                {step.number}
              </div>
