...
export function Navbar() {
  ...
  const borderColor = useTransform(
    scrollY,
    [0, 100],
    ['rgba(139, 92, 246, 0.0)', 'rgba(139, 92, 246, 0.3)']
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button className="px-4 py-2 bg-gradient-to-r from-purple-600 to-purple-800 text-white rounded-lg font-medium hover:from-purple-500 hover:to-violet-600 transition-all duration-200 shadow-md hover:shadow-lg">
              Get Started
            </button>
          </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <button className="px-4 py-2 bg-gradient-to-r from-purple-600 to-purple-800 text-white rounded-lg font-medium hover:from-purple-500 hover:to-violet-600 transition-all duration-200 shadow-md">
                Get Started
              </button>
            </div>
          </motion.div>
